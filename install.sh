...
#install packages
<<<<<<< HEAD
sudo pacman -S base-devel sddm alacritty kitty unzip nmap alsa-utils qtile pyright nwg-look metasploit lua-language-server pavucontrol blueman wireshark-qt clang fish gcc gdb eza udiskie github-cli btop neovim picom redshift rofi zellij rofi ruby starship npm ripgrep fzf feh ranger discord firefox nitrogen nemo samba ghidra dunst flameshot xorg-xrandr lxqt-policykit pasystray obsidian nerd-fonts -y
=======
sudo pacman -S base-devel sddm alacritty kitty unzip nmap qtile pyright nwg-look metasploit lua-language-server pavucontrol blueman wireshark-qt clang fish zoxide gcc gdb eza udiskie github-cli btop neovim picom redshift rofi zellij rofi ruby starship npm ripgrep fzf feh ranger discord firefox nitrogen nemo samba ghidra dunst flameshot xorg-xrandr lxqt-policykit pasystray obsidian nerd-fonts -y
>>>>>>> 6da5995 (added package)
sleep 4
